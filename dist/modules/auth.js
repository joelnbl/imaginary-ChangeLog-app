...
var comparePasswords = function (password, hashedPassword) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, bcrypt_1.default.compareSync(password, hashedPassword)];
...
var hashPassword = function (password) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, bcrypt_1.default.hashSync(password, 10)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
...
var protect = function (req, res, next) {
    ...
    try {
        ...
        try {
            ...
            var payload_1 = jsonwebtoken_1.default.verify(token, jwtSecret);
        }
        catch (error) {
